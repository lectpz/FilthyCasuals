...
local function SDcontext(player, context, items) -- # When an inventory item context menu is opened
	...
	for _, item in ipairs(items) do -- Check every item in inventory array
		...
		if iFT == 'Base.WeaponCache' or iFT == 'Base.MedicalCache' or iFT == 'Base.MechanicCache' or iFT == 'Base.MetalworkCache' or iFT == 'Base.AmmoCache' or iFT == 'Base.ArmorCachePatriot' or iFT == 'Base.ArmorCacheDefender' or iFT == 'Base.ArmorCacheVanguard' or iFT == 'Base.SpiffoCache' or iFT == 'Base.JewelryCache' or iFT == 'Base.SoulForgeCache' or iFT == 'Base.PokemonCache' or iFT == 'Base.ShinyPokemonCache' or iFT == 'Base.ChiikuCache' then
