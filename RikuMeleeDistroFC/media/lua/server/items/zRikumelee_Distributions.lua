...
local function preDistributionMerge()
	...
	table.insert(ProceduralDistributions.list.StoreShelfMedical.items, 0.5);
	...
	table.insert(ProceduralDistributions.list.GarageCarpentry.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.GarageCarpentry.items, 0.00001);
	...
	table.insert(ProceduralDistributions.list.GarageTools.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.GarageTools.items, 0.00001);
	...
	table.insert(ProceduralDistributions.list.WardrobeChild.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.WardrobeChild.items, 0.0000001);
	...
	table.insert(ProceduralDistributions.list.Hobbies.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.Hobbies.items, 0.0000001);
	...
	table.insert(ProceduralDistributions.list.MusicStoreBass.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.MusicStoreBass.items, 0.00001);

	table.insert(ProceduralDistributions.list.GarageMetalwork.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.GarageMetalwork.items, 0.00001);
	
	table.insert(ProceduralDistributions.list.LivingRoomShelf.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.LivingRoomShelf.items, 0.000001);
	...
	table.insert(ProceduralDistributions.list.GigamartHousewares.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.GigamartHousewares.items, 0.00001);
	...
	table.insert(ProceduralDistributions.list.GunStoreAmmunition.items, 0.002);
	...
	table.insert(ProceduralDistributions.list.GunStoreDisplayCase.items, 0.002);
	
	table.insert(ProceduralDistributions.list.PoliceStorageAmmunition.items, "WeaponCache");
	table.insert(ProceduralDistributions.list.PoliceStorageAmmunition.items, 0.002);
