...
function ItemGenerator.SetResultName(result)
    ...
    local baseItemName = currentName:match("SoulForged (.+)$") or currentName
    ...
    if showTier then
        ...
        newItemName = "[T" .. displayTier .."] " .. (combinedBuffName or "Unknown") .. " SoulForged " .. (baseItemName or "Item")
    else
        newItemName = (combinedBuffName or "Unknown") .. " SoulForged " .. (baseItemName or "Item")
    end
