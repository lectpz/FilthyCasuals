	...
	if character ~= nil and not handWeapon:isRanged() then
		...
		if tierzone then
			...
			if	playerItem:getModData().CriticalChance == nil and
				playerItem:getModData().getCritDmgMultiplier == nil and
				playerItem:getModData().getMinDamage == nil and
				playerItem:getModData().getMaxDamage == nil then
...
function WeaponCheckFC(character, inventoryItem)
	...
	elseif inventoryItem:IsWeapon() and not inventoryItem:isRanged() then
		if	inventoryItem:getModData().CriticalChance == nil and
			inventoryItem:getModData().getCritDmgMultiplier == nil and
			inventoryItem:getModData().getMinDamage == nil and
			inventoryItem:getModData().getMaxDamage == nil then
