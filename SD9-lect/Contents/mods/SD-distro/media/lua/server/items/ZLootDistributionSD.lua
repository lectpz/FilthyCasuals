...
local function editDistributions()
	...
	local removeItems = {"Base.TanPlating", "Base.BluePlating", "Base.RedPlating", "Base.GoldGunPlating", "Base.RainbowPlating", "Base.DZPlating", "Base.RemingtonRiflesDarkCherryStock", "Base.WinterCamoPlating", "Base.WoodStyledPlating", "Base.PinkPlating", "Base.RedWhitePlating", "Base.GreenGoldPlating", "Base.AztecPlating", "Base.DesertEagleGoldPlating", "Base.GoldShotgunPlating", "Base.RainbowAnodizedPlating", "Base.GreenPlating", "Base.SteelDamascusPlating", "Base.SalvagedRagePlating", "Base.ZoidbergSpecialPlating", "Base.NerfPlating", "Base.BespokeEngravedPlating", "Base.SurvivalistPlating", "Base.MysteryMachinePlating", "Base.SalvagedBlackPlating", "Base.PlankPlating", "Base.BlackIcePlating", "Base.BlackDeathPlating", "Base.OrnateIvoryPlating", "Base.GildedAgePlating", "Base.TBDPlating", "Base.CannabisPlating", "Base.Mag9Drum", "Base.Mag57Drum", "Base.MagLugerDrum", "Base.Mag380Drum", "Base.Mag45Drum", "Base.M911Bullbar0", "Base.90bmwE30Bullbar", "Base.67gt500RearBullbar", "Base.93fordTaurusBullbarFrontA", "Base.M911Bullbar1", "Base.67gt500FrontBullbar", "Base.87buickRegalBullbar", "Base.82porsche911BullbarFrontA", "Base.97BushBullbarSAS", "Base.80sPickupBullbarRear", "Base.88toyotaHiluxBullbarFrontA", "Base.86chevyCUCVBullbarFrontC", "Base.98stageaBullbarFrontA", "Base.80sPickupBullbarFront", "Base.89trooperBullbarFrontA", "Base.89trooperBullbarFrontB", "Base.CUDARearBumperA", "Base.82JeepJ10BullbarFront", "Base.86chevyCUCVBullbarFrontA", "Base.CUDAFrontBumperA", "Base.90fordF350BullbarFront", "Base.81deloreanDMC12Bullbar", "Base.E150FrontBullbar2", "Base.85gmBbodyBullbarFrontA", "Base.87fordF700BullbarFrontA", "Base.87toyotaMR2BullbarFrontA", "Base.89volvo240BullbarFrontA", "Base.82firebirdBumperFrontA", "Base.77firebirdBullbarFrontA", "Base.93townCarBullbarFrontA", "Base.93townCarBullbarFrontB", "Base.93townCarBullbarFrontC", "Base.91rangeBullbarRearA", "Base.89BroncoBullbarFront", "Base.49powerWagonBullbar1", "Base.91rangeBullbarFrontA", "Base.88toyotaHiluxBullbarRearA", "Base.87fordB700BullbarFrontA", "Base.75grandPrixBullbar", "Base.87chevySuburbanBullbarFrontA", "Base.W460Bullbar2_Item", "Base.76chevyKseriesBullbarFrontA", "Base.93fordF350BullbarFrontA", "Base.88ChevyS10BullbarFront", "Base.M998Bullbar2_Item", "Base.89dodgeCaravanBullbarFrontA", "Base.86chevyCUCVBullbarFrontB", "Base.M998Bullbar1_Item", "Base.DG70RearBumperA", "Base.DG70RearBumperB", "Base.DG70RearBumperC", "Base.69camaroRearBumperA", "Base.92jeepYJBullbarFrontA", "Base.DG70FrontBumperA", "Base.DG70FrontBumperB", "Base.DG70FrontBumperC", "Base.ECTO1Bullbar1_Item", "Base.69camaroFrontBumperA", "Base.84jeepXJBullbarFrontA", "Base.E150FrontBumperWithBullbar2", "Base.49powerWagonBullbar2", "Base.W460BullbarM_Item", "Base.89volvo240BumperFrontB", "Base.93chevySuburbanBullbarFrontB", "Base.R32BumperRearA", "Base.R32BumperA", "Base.93chevySuburbanBullbarFrontC", "Base.91geoMetroReinforcedBumperFront1", "Base.93fordF350BumperFrontB", "Base.77firebirdBumperFrontA", "Base.W460Bullbar3_Item", "Base.69camaroRearBumperB", "Base.ECTO1BumperA_Item", "Base.69camaroFrontBumperB"}

	for i=1,#removeItems do
		yeetItem(removeItems[i])
		yeetItem(removeBaseFromFullType(removeItems[i]))
	end
