...
MDZ_OnCreate_MeleeWeaponVariance = function(item, cache)
	...
	if cache and cache == "OZD" and (isAdmin() or isDebugEnabled()) then return end-- if it's a cache and you're superuser, just close so you don't double dip and cause naming issues
