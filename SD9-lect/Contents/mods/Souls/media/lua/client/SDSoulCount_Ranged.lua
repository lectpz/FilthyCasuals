...
local pref1_args = {
	Accurate = getStat("Prefix", "Accurate", "getAimingPerkHitChanceModifier", 1.1, posDesc("getAimingPerkHitChanceModifier")),
	Honed = getStat("Prefix", "Honed", "getAimingPerkCritModifier", 1.1, posDesc("getAimingPerkCritModifier")),
	Quick = getStat("Prefix", "Quick", "getAimingTime", 1.2, posDesc("getAimingTime")),
	Steady = getStat("Prefix", "Steady", "getAimingPerkRangeModifier", 1.1, posDesc("getAimingPerkRangeModifier")),
...
local suff1_args = {
	Focused = getStat("Suffix", "Focused", "getAimingPerkHitChanceModifier", 1.1, posDesc("getAimingPerkHitChanceModifier")),
	Deadly = getStat("Suffix", "Deadly", "getAimingPerkCritModifier", 1.1, posDesc("getAimingPerkCritModifier")),
	Swift = getStat("Suffix", "Swift", "getAimingTime", 1.2, posDesc("getAimingTime")),
	Precise = getStat("Suffix", "Precise", "getAimingPerkRangeModifier", 1.1, posDesc("getAimingPerkRangeModifier")),
...
local suff2_args = {
    SundayDriver =	function(item)
						...
						local description = gold .. "Suffix Modifer: Sunday Driver" ..
								green .. " <LINE> (Requires Soul Wrought) Max Hit Count +" .. sm1 ..
								green .. " <LINE> " .. string.format("%.0f", (sm2*100-100))  .. "% More Aiming Time" ..
