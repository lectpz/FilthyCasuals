...
local pref1_args = {
	Brave = getStat("Prefix", "Brave", "getMinDamage", 1.05, posDesc("getMinDamage")),
	Cromulent = getStat("Prefix", "Cromulent", "getConditionLowerChance", 1.1, posDesc("getConditionLowerChance")),
	Desensitized = getStat("Prefix", "Desensitized", "getCriticalChance", 1.05, posDesc("getCriticalChance")),
	Embiggened = getStat("Prefix", "Embiggened", "getCritDmgMultiplier", 1.05, posDesc("getCritDmgMultiplier")),
	Enraged = getStat("Prefix", "Enraged", "getMaxDamage", 1.05, posDesc("getMaxDamage")),
...
local suff1_args = {
	...
	Dedicated = getStat("Suffix", "Dedicated", "getMinDamage", 1.05, posDesc("getMinDamage")),
	Enlightened = getStat("Suffix", "Enlightened", "getMaxDamage", 1.05, posDesc("getMaxDamage")),
	Indifferent = getStat("Suffix", "Indifferent", "getConditionMax", 1.1, posDesc("getConditionMax")),
	Malding = getStat("Suffix", "Malding", "getCritDmgMultiplier", 1.05, posDesc("getCritDmgMultiplier")),
	Savage = getStat("Suffix", "Savage", "getCriticalChance", 1.05, posDesc("getCriticalChance")),
}
...
local pref2_args = {
    ...
    Absolutionist =	function(item)
						...
						local sm1, sm2, sm3 = 1.15, 0.9, 0.9
						...
						local description = gold .. "Prefix Modifer: Absolutionist" ..
								...
								orange .. " <LINE> " .. string.format("%.0f", (100-sm3*100))  .. "% Less Maximum Weapon Condition <LINE> "
	...
	Decimator	 =	function(item)
						...
						local sm1, sm2, sm3 = 1.25, 0.85, 0.85
						...
						local description = gold .. "Prefix Modifer: Decimator" ..
								...
								orange .. " <LINE> " .. string.format("%.0f", (100-sm2*100))  .. "% Less Weapon Condition Lower Chance" ..
								orange .. " <LINE> " .. string.format("%.0f", (100-sm3*100))  .. "% Less Maximum Weapon Condition <LINE> "
	...
	Reaver 		=	function(item)
						...
						local sm1, sm2, sm3 = 1.2, 0.9, 0.85
...
local suff2_args = {
    SundayDriver =	function(item)
						...
						local description = gold .. "Suffix Modifer: Sunday Driver" ..
								...
								orange .. " <LINE> " .. string.format("%.0f", (100-sm2*100)) .. "% Less Minimum Damage" ..
								orange .. " <LINE> " .. string.format("%.0f", (sm3*100-100))  .. "% More Endurance Used"
    ...
    ApocalypseEnjoyer =	function(item)
						...
						local description = gold .. "Suffix Modifer: Apocalypse Enjoyer" ..
								green .. " <LINE> " .. string.format("%.0f", (sm1*100-100))  .. "% More Maximum Damage" ..
								orange .. " <LINE> " .. string.format("%.0f", (100-sm2*100))  .. "% Less Maximum Weapon Condition" ..
								orange .. " <LINE> " .. string.format("%.0f", (100-sm3*100))  .. "% Less Weapon Condition Lower Chance <LINE> "
	...
	AscendedPath =	function(item)
						...
						local sm1, sm2, sm3 = 1.3, 0.8, 0.75
	...
	for _, item in ipairs(items) do -- Check every item in inventory array
		if item:IsWeapon() and not item:isRanged() then
			...
			local function itemStats()
				...
				tooltip.description = tooltip.description .. green .. " <LINE> Extra Base Maximum Damage: +" .. math.floor(soulPower * 10)/10 .. " <LINE> "
				tooltip.description = tooltip.description .. green .. "Extra Base Critical Chance: +" .. math.floor(soulPower * 50)/10 .. "% <LINE> "
				tooltip.description = tooltip.description .. green .. "Extra Base Critical Multi: +" .. math.floor(soulPower * 50)/100 .. "x <LINE> "
				
				tooltip.description = tooltip.description .. white .. " <LINE> DEBUG - Endurance Mod: " .. math.ceil(item:getEnduranceMod()*100)/100
				
				local isAugmented = weaponModData.Augments or nil
				
				if isAugmented then tooltip.description = tooltip.description .. white .. " <LINE> DEBUG - No. of Augments: " .. weaponModData.Augments .. " <LINE> <LINE> " end
