...
local function OnPostDistributionMerge()
	...
	local yeetitem = {"CanteensAndBottles.JerryCanTank", "CanteensAndBottles.JumboJerryCanTank", "PropaneTank", "TW.LargePropaneTank", "Base.PropaneTank", "TW.HugePropaneTank"}
